...
const defaultGalleryImages = [
  ...
  { src: "https://res.cloudinary.com/bali5bin/video/upload/f_auto,q_auto,w_1920/v1784915389/drone_tiseph.mp4", title: "Drone View", category: "Videos", colSpan: "col-span-1 md:col-span-2", rowSpan: "row-span-2", type: "video" },
